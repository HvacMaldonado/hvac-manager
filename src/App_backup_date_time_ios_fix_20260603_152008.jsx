          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="h-16 w-full appearance-none rounded-[1.35rem] border border-cyan-100 bg-white px-4 text-base font-black text-slate-950 shadow-md shadow-cyan-100/40 outline-none transition focus:border-cyan-400 focus:ring-4 focus:ring-cyan-100"
              />
            </label>
