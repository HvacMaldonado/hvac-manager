...
function LoginScreen({ t, lang, setLang, loginForm, setLoginForm, iniciarSesion, mensaje }) {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-slate-950 p-4 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_12%_18%,rgba(249,115,22,.42),transparent_31%),radial-gradient(circle_at_85%_20%,rgba(34,211,238,.40),transparent_30%),radial-gradient(circle_at_50%_95%,rgba(37,99,235,.32),transparent_38%),linear-gradient(135deg,#020617_0%,#0f172a_48%,#111827_100%)]" />
      ...
      <div className="absolute left-[-8rem] top-24 h-96 w-96 rounded-full bg-orange-500/25 blur-3xl" />
      <div className="absolute right-[-8rem] bottom-16 h-[28rem] w-[28rem] rounded-full bg-cyan-400/25 blur-3xl" />
      ...
      <section className="relative w-full max-w-md overflow-hidden rounded-[2.75rem] border border-white/20 bg-white/[0.11] p-7 shadow-2xl shadow-black/50 backdrop-blur-2xl sm:p-8">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-5 flex h-36 w-36 items-center justify-center rounded-[2rem] border border-white/20 bg-white/10 p-3 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
            <img
              src="/logo-hvac-maldonado.jpg"
              alt="HVAC Refrigeración Maldonado R"
              className="h-full w-full object-contain drop-shadow-[0_0_24px_rgba(34,211,238,.32)]"
            />
          </div>
          ...
          <p className="mx-auto mt-2 max-w-xs text-sm font-medium leading-relaxed text-white/60">
        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="group flex items-center gap-3 rounded-2xl border border-white/15 bg-white/10 px-4 py-3.5 shadow-inner shadow-white/5 transition focus-within:border-cyan-300/70 focus-within:bg-white/[0.14] focus-within:shadow-[0_0_32px_rgba(34,211,238,.25)]">
              ...
              <input
                ...
                placeholder={t("user")}
                className="w-full bg-transparent text-sm font-bold text-white placeholder:text-white/35 outline-none"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 via-blue-600 to-cyan-400 px-5 py-4 font-black uppercase tracking-[0.2em] text-white shadow-2xl shadow-cyan-500/25 transition hover:-translate-y-0.5 hover:shadow-cyan-400/40"
          >
