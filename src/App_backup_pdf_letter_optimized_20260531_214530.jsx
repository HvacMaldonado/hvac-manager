...
<head>
  ...
  <style>
    *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    ...
    .header{display:grid;grid-template-columns:1.2fr .8fr;gap:24px;align-items:start;border-bottom:4px solid #1d4ed8;padding-bottom:22px;margin-bottom:22px}
    .brand{display:flex;gap:18px;align-items:center}
    .logo{width:190px;height:120px;background:transparent;border:none;padding:0;display:flex;align-items:center;justify-content:center}
    .logo img{max-width:100%;max-height:100%;object-fit:contain}
    h1{margin:0;font-size:28px;line-height:1.05;letter-spacing:-.04em;color:#0f172a}
    ...
    .meta .id{font-size:30px;font-weight:900;color:#0f172a;letter-spacing:-.05em}
    ...
    .card{border:2px solid #dbeafe;border-radius:18px;padding:14px;background:white}
    ...
    .row{display:grid;grid-template-columns:90px 1fr;gap:8px;border-top:1px solid #e2e8f0;padding:7px 0}
    ...
    .text-box{border:2px solid #dbeafe;border-radius:18px;padding:14px;min-height:44px;white-space:pre-wrap;font-weight:700}
    ...
    .photo-frame{height:130px;display:flex;align-items:center;justify-content:center;border-bottom:1px solid #dbeafe}
    ...
    .footer{margin-top:22px;border-top:4px solid #1d4ed8;padding-top:12px;display:flex;justify-content:space-between;color:#64748b;font-size:12px;font-weight:800}
    @media print{
      body{background:white}
      .page{margin:0;max-width:none;padding:10mm}
            ...
            <div className="mt-3 space-y-3 rounded-2xl border border-slate-200 bg-white p-3">
              ...
              <div className="flex flex-wrap gap-2">
                {orden.estado === "Asignada" && (
                  <button onClick={() => marcarEnRuta(orden.id)} className="flex items-center justify-center gap-1.5 rounded-xl bg-blue-600 px-2.5 py-1.5 text-[11px] font-bold text-white">
                ...
                {orden.estado === "En ruta" && (
                  <button onClick={() => marcarLlegada(orden.id)} className="flex items-center justify-center gap-1.5 rounded-xl bg-indigo-600 px-2.5 py-1.5 text-[11px] font-bold text-white">
                    <MapPin {...iconProps} />
                    Llegué al sitio
                  </button>
                )}
