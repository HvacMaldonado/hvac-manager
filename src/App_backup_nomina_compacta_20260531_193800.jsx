    ...
    <section className="space-y-3">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {filas.map((row) => (
          <article
            key={row.tecnico.id}
            className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md shadow-slate-200/80 transition-all hover:-translate-y-0.5 hover:shadow-xl"
          >
            <div className="bg-gradient-to-r from-blue-800 via-blue-700 to-cyan-600 p-4 text-white">
