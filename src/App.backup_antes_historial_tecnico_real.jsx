        ...
        {session.role === "tecnico" && (
          <>
            ...
            {tecnicoVista === "historial" && (
              <section className="rounded-3xl border border-slate-200 bg-white/95 p-8 text-center shadow-xl shadow-slate-300/50">
                <div className="mx-auto max-w-xl">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-emerald-600 to-slate-950 text-white shadow-xl">
                    <History size={30} />
                  </div>
                  ...
                  <p className="mt-3 text-sm font-semibold text-slate-500">
                    Aquí irá la página dedicada para órdenes completadas y canceladas del técnico.
                  </p>

                  <div className="mt-6 grid gap-3 sm:grid-cols-3">
                    <div className="rounded-2xl bg-slate-100 p-4">
                      <p className="text-2xl font-black">{historialTecnico.length}</p>
                      <p className="text-xs font-black uppercase text-slate-500">Todas</p>
                    </div>

                    <div className="rounded-2xl bg-emerald-50 p-4 text-emerald-800">
                      <p className="text-2xl font-black">
                        {historialTecnico.filter((o) => o.estado === "Completado").length}
                      </p>
                      <p className="text-xs font-black uppercase">Completadas</p>
                    </div>

                    <div className="rounded-2xl bg-rose-50 p-4 text-rose-800">
                      <p className="text-2xl font-black">
                        {historialTecnico.filter((o) => o.estado === "Cancelada").length}
                      </p>
                      <p className="text-xs font-black uppercase">Canceladas</p>
                    </div>
                  </div>
                </div>
              </section>
