      ...
      <main className="w-full min-w-0 px-2.5 2xl:px-6 py-3 2xl:py-5">
        ...
        {session.role === "admin" && (
          <>
            ...
            {adminPage === "dashboardReportes" && <ReportesDashboardPage t={t} clientes={clientes} ordenes={ordenes} inventario={inventario} herramientas={herramientas} tecnicos={tecnicos} obtenerCliente={obtenerCliente} obtenerTecnico={obtenerTecnico} exportarCSV={exportarCSV} />}
