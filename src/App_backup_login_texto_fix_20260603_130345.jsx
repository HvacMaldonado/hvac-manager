          ...
          <div>
            ...
            <div className="group flex items-center gap-3 rounded-2xl border border-white/15 bg-white/10 px-4 py-3.5 shadow-inner shadow-white/5 transition focus-within:border-cyan-300/70 focus-within:bg-white/[0.14] focus-within:shadow-[0_0_32px_rgba(34,211,238,.25)]">
              ...
              <input
                ...
                placeholder={t("user")}
                className="login-glass-input block w-full min-w-0 appearance-none rounded-xl border-0 bg-transparent px-0 py-0 text-sm font-bold text-white placeholder:text-white/35 outline-none shadow-none ring-0 [background-color:transparent!important] [caret-color:white] [text-shadow:0_0_1px_rgba(255,255,255,.45)] focus:bg-transparent focus:outline-none focus:ring-0"
              />
            </div>
          </div>
