...
function LoginScreen({ t, lang, setLang, loginForm, setLoginForm, iniciarSesion, mensaje }) {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-slate-950 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(249,115,22,.35),transparent_32%),radial-gradient(circle_at_85%_15%,rgba(34,211,238,.35),transparent_28%),radial-gradient(circle_at_50%_100%,rgba(59,130,246,.25),transparent_35%),linear-gradient(135deg,#020617_0%,#0f172a_50%,#111827_100%)]" />

      <div className="absolute left-[-10%] top-[20%] h-72 w-72 rounded-full bg-orange-500/20 blur-3xl" />
      <div className="absolute right-[-10%] bottom-[10%] h-80 w-80 rounded-full bg-cyan-400/20 blur-3xl" />

      <section className="relative w-full max-w-md rounded-[2.5rem] border border-white/20 bg-white/10 p-8 shadow-2xl shadow-black/40 backdrop-blur-2xl">

        <div className="mb-8 text-center">

          <img
            src="/logo-hvac-maldonado.jpg"
            alt="HVAC Refrigeración Maldonado R"
            className="mx-auto mb-6 h-40 w-auto object-contain drop-shadow-[0_0_25px_rgba(34,211,238,.25)]"
          />
          ...
          <p className="mt-2 text-sm font-medium text-white/60">
            Premium HVAC Operations Platform
          </p>
        ...
        <div className="space-y-5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={t("user")}
              className="w-full rounded-2xl border border-white/15 bg-white/10 px-12 py-4 text-white placeholder:text-white/35 outline-none shadow-sm transition focus:border-cyan-300 focus:ring-4 focus:ring-cyan-300/30"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/15 bg-white/10 px-12 py-4 text-white placeholder:text-white/35 outline-none shadow-sm transition focus:border-orange-300 focus:ring-4 focus:ring-orange-300/30"
              onKeyDown={(e) =>
                e.key === "Enter" && iniciarSesion()
              }
            />
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 via-blue-600 to-cyan-500 px-5 py-4 font-black text-white shadow-xl shadow-cyan-500/20 transition hover:-translate-y-0.5 hover:shadow-cyan-400/30"
          >
            <LogIn {...iconProps} />
            {t("login")}
          </button>
        ...
        {mensaje && (
          <p className="mt-5 rounded-2xl border border-white/10 bg-white/10 p-4 text-sm font-semibold text-cyan-100 backdrop-blur-md">
            {mensaje}
          </p>
        )}
