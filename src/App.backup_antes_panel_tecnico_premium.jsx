                      ...
                      <div className="flex flex-wrap gap-1.5 lg:justify-end">
                        {cliente?.telefono && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-600 px-2.5 py-1.5 text-[11px] font-black text-white"
                          >
                            <Phone size={14} />
                            Llamar
                          </a>
                        ...
                        {cliente?.direccion && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-1.5 rounded-xl bg-slate-950 px-2.5 py-1.5 text-[11px] font-black text-white"
                          >
                            <Navigation size={14} />
                            Mapa
                          </a>
                        ...
                        {ordenProps?.compartirOrden && (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 px-2.5 py-1.5 text-[11px] font-black text-white"
                          >
                            <Printer size={14} />
                            Imprimir
                          </button>
