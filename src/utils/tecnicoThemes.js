...
export const TECNICO_COLOR_THEMES = {
  ...
  naranja: {
    name: "Índigo",
    label: "Índigo",
    event: "border-indigo-200 bg-indigo-50 text-indigo-950",
    dot: "bg-indigo-500",
    header: "bg-gradient-to-r from-indigo-950 via-blue-900 to-cyan-700",
    chip: "bg-indigo-300/25 text-indigo-50 ring-indigo-100/30",
    border: "border-indigo-300",
    body: "bg-indigo-50/80",
    buttonActive: "border-indigo-400 bg-indigo-50 text-indigo-800 ring-4 ring-indigo-100",
    buttonIdle: "border-indigo-200 bg-white text-slate-700 hover:border-indigo-400 hover:bg-indigo-50",
  },
  rosa: {
    name: "Rosa",
    label: "Rosa",
