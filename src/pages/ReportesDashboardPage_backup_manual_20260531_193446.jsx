        ...
        <section className="rounded-2xl border border-slate-200 bg-white/95 p-3 shadow-md shadow-slate-300/50">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {data.tecnicoStats.slice(0, 8).map((tec) => (
              <div
                key={tec.id}
                className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-md shadow-slate-300/50 transition-all hover:-translate-y-0.5 hover:shadow-lg"
              >
                <div className="bg-gradient-to-r from-blue-800 to-cyan-600 p-4 text-white">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-bold text-blue-100">
                        {tec.total} órdenes · {tec.efectividad}% efectividad
                      </p>
                    </div>
                ...
                <div className="p-4">
                  <div className="grid grid-cols-2 gap-3 text-sm font-black">
                    <div className="rounded-2xl bg-blue-50 p-3 text-blue-700">
                      ...
                      <p className="mt-1 text-lg text-slate-950">
                        {tec.horasTrabajo.toFixed(2)} h
                      </p>
                    </div>

                    <div className="rounded-2xl bg-cyan-50 p-3 text-cyan-700">
                      <p className="text-[10px] uppercase tracking-wide text-cyan-500">
                        Traslado
                      </p>
                      <p className="mt-1 text-lg text-slate-950">
                        {tec.horasTraslado.toFixed(2)} h
                      </p>
                    </div>
                  ...
                  <div className="mt-4">
                    <SimpleBar
                      label={`${tec.completadas} completadas · ${tec.canceladas} canceladas`}
                      value={tec.total}
                      max={maxTecnico}
                    />
                  </div>
