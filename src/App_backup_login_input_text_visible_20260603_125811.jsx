        ...
        <div className="mb-8 text-center">
          <div className="mb-8 flex justify-center">
            <img
              ...
              className="h-52 w-auto object-contain drop-shadow-[0_0_45px_rgba(34,211,238,.22)]"
            />
          </div>
          ...
          <div>
            ...
            <div className="group flex items-center gap-3 rounded-2xl border border-white/15 bg-white/10 px-4 py-3.5 shadow-inner shadow-white/5 transition focus-within:border-cyan-300/70 focus-within:bg-white/[0.14] focus-within:shadow-[0_0_32px_rgba(34,211,238,.25)]">
              ...
              <input
                ...
                placeholder={t("user")}
                className="login-glass-input block w-full min-w-0 appearance-none rounded-xl border-0 bg-slate-950/20 px-0 py-0 text-sm font-bold text-white placeholder:text-white/35 outline-none shadow-none ring-0 [background-color:transparent!important] [-webkit-background-clip:text] [caret-color:white] focus:bg-transparent focus:outline-none focus:ring-0"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              ...
              <div className="mt-3 rounded-2xl bg-white/10 p-3">
                <p className="line-clamp-2 text-sm font-bold leading-relaxed text-white/95">
                  {orden.problema || "Sin problema reportado"}
                </p>
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-1.5 rounded-xl bg-white/15 px-3 py-1.5 text-[11px] font-black text-cyan-100 ring-1 ring-white/15 transition hover:bg-white/20"
                >
                  <Languages size={13} />
                  Traducir problema
                </button>
