...
function Info({ titulo, valor, extra = "bg-white", icon: Icon = FileText }) {
  return (
    <div className={`rounded-[1.35rem] border border-cyan-200 bg-gradient-to-br from-cyan-50 via-white to-blue-50 p-4 text-sm shadow-lg shadow-cyan-100/60 ${extra}`}>
