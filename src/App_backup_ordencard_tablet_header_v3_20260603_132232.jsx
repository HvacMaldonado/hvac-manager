      ...
      <div className="p-4">
        <div className={`overflow-hidden rounded-[1.75rem] border ${tarjetaEstadoClase}`}>
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              <div className="mb-3 inline-flex items-center gap-2 rounded-2xl bg-white/15 px-4 py-2 text-white ring-1 ring-white/20 shadow-sm">
                <Clock3 size={18} />
                <span className="text-2xl font-black tracking-tight">{horaTexto}</span>
              </div>
