...
<head>
  ...
  <style>
    *{box-sizing:border-box}
    ...
    .logo{width:180px;height:110px;background:transparent;border:none;padding:0;overflow:visible;display:flex;align-items:center;justify-content:center}
...
<body>
  <main class="page">
    <header class="header">
      <div class="brand">
        <div class="logo"><img src="/logo-hvac-maldonado.jpg" style="max-width:100%;max-height:100%;object-fit:contain;" /></div>
        <div>
