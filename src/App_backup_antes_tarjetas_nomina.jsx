    ...
    <section className="space-y-3">
      ...
      <div className="grid gap-3">
        {filas.map((row) => (
          <article
            key={row.tecnico.id}
            className="rounded-2xl border border-slate-200 bg-white p-3 shadow-md shadow-slate-200/70"
          >
