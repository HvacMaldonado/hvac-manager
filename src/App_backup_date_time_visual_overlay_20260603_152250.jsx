        ...
        <main className="space-y-4 bg-[radial-gradient(circle_at_top_right,_#22d3ee33,_transparent_28%),linear-gradient(135deg,_#eff6ff_0%,_#ecfeff_55%,_#f8fafc_100%)] p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="block">
              ...
              <div className="flex h-16 items-center rounded-[1.35rem] border border-cyan-100 bg-white px-4 shadow-md shadow-cyan-100/40">
                <CalendarDays size={20} strokeWidth={2.6} className="mr-3 shrink-0 text-cyan-600" />
                <input
                  type="date"
                  value={fecha}
                  onChange={(e) => setFecha(e.target.value)}
                  className="min-h-0 w-full appearance-none border-0 bg-transparent p-0 text-base font-black leading-none text-slate-950 outline-none ring-0 focus:outline-none focus:ring-0"
                />
              </div>
            </label>
