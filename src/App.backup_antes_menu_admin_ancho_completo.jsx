    ...
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_#0f172a55,_transparent_30%),radial-gradient(circle_at_top_right,_#0284c733,_transparent_28%),radial-gradient(circle_at_bottom_left,_#1e40af2e,_transparent_30%),linear-gradient(135deg,_#e2e8f0_0%,_#cbd5e1_48%,_#94a3b8_100%)] text-slate-900">
      <header className="sticky top-0 z-20 border-b border-slate-900/10 bg-slate-950/90 text-white backdrop-blur-xl shadow-2xl shadow-slate-900/30">
        <div className="w-full px-3 2xl:px-8 py-2.5 2xl:py-4 flex flex-col 2xl:flex-row 2xl:items-center 2xl:justify-between gap-2.5 2xl:gap-4">
          <div><p className="text-[10px] 2xl:text-xs uppercase tracking-[0.24em] 2xl:tracking-[0.3em] text-indigo-200 font-black">{t("app")}</p><h1 className="text-lg 2xl:text-lg font-black tracking-tight text-white">{session.role === "admin" ? t("adminPanel") : `${t("techPanel")}: ${session.nombre}`}</h1></div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm">
            <div className="w-full max-w-md overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl shadow-slate-950/40">
              ...
              <div className="grid gap-3 p-5">
                ...
                <button onClick={() => abrirProgramarCitaConCliente(clienteAccion)} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-3 font-black text-white shadow-lg">
        ...
        {session.role === "tecnico" && (() => {
          ...
          return (
            <>
              ...
              <section className="mb-3 overflow-hidden rounded-[1.4rem] border border-white/70 bg-white/80 shadow-xl shadow-slate-400/30 backdrop-blur">
                <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-800 to-indigo-900 px-4 py-3 text-white">
                  ...
                  <div className="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[9px] font-black uppercase tracking-[0.28em] text-indigo-200">
                          Panel del técnico
                        </p>
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-2">
                        <span className={
                          ...
                          (tecnicoVista === "agenda" ? "bg-indigo-500/20 text-cyan-200" : "bg-indigo-50 text-cyan-700")
                        }>
                          <CalendarDays size={18} />
                        </span>
                        <div>
...
function TopInfo({ now }) {
  return (
    <div className="flex items-center gap-2 2xl:gap-6 bg-gradient-to-r from-slate-950 via-slate-800 to-indigo-900 text-white px-3 2xl:px-6 py-2 2xl:py-4 rounded-xl 2xl:rounded-2xl shadow-lg shadow-indigo-200/40">
      <div className="flex items-center gap-1.5 2xl:gap-2">
        <CalendarDays className="w-3.5 h-3.5 2xl:w-5 2xl:h-5 text-indigo-300" strokeWidth={2} />
  ...
  return (
    <section className="mb-6 space-y-4">
      <div className="overflow-hidden rounded-3xl border border-white/70 bg-white/95 shadow-xl shadow-slate-300/60 backdrop-blur">
        <div className="bg-gradient-to-br from-slate-950 via-slate-800 to-indigo-900 px-5 py-3 text-white">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-indigo-200">Agenda del técnico</p>
              <h2 className="mt-1 flex items-center gap-2 text-lg font-black">
