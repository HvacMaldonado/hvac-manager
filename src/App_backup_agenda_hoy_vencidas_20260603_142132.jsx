        ...
        <div className="space-y-3">
          {ordenesHoy.map((orden) => {
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-800 px-4 py-5 text-white shadow-xl shadow-cyan-900/20 ring-1 ring-cyan-300/20">
                  <div className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-cyan-400/20 blur-2xl" />
                  <div className="relative text-center">
                    <p className="text-[9px] font-black uppercase tracking-[0.28em] text-cyan-200">
                      Hora
                    </p>
