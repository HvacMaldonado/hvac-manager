          ...
          return (
            <>
              ...
              <section className="mb-3 overflow-hidden rounded-[1.4rem] border border-white/70 bg-white/80 shadow-xl shadow-slate-400/30 backdrop-blur">
                <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-900 px-4 py-3 text-white">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-2">
                        <span className={
                          ...
                          (tecnicoVista === "agenda" ? "bg-cyan-500/20 text-cyan-200" : "bg-cyan-50 text-cyan-700")
                        }>
                          <CalendarDays size={18} />
                        </span>
                        <div>
