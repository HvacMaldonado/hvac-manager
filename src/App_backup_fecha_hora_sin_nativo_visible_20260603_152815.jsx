        ...
        <main className="space-y-4 bg-[radial-gradient(circle_at_top_right,_#22d3ee33,_transparent_28%),linear-gradient(135deg,_#eff6ff_0%,_#ecfeff_55%,_#f8fafc_100%)] p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="block">
              ...
              <div className="relative flex h-16 items-center overflow-hidden rounded-[1.35rem] border border-cyan-100 bg-white px-4 shadow-md shadow-cyan-100/40">
                ...
                <input
                  ...
                  className="absolute inset-0 z-20 h-full w-full cursor-pointer appearance-none border-0 bg-transparent text-transparent opacity-0 outline-none [-webkit-appearance:none] [color:transparent]"
                />
              </div>
            </label>
