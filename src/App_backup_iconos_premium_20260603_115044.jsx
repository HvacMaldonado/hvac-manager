  ...
  return (
    <div className={`group rounded-2xl border border-cyan-100 bg-white/90 p-3 shadow-md shadow-cyan-100/50 ring-1 ring-white transition hover:-translate-y-0.5 hover:shadow-lg ${extra}`}>
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-500 text-white shadow-md shadow-cyan-200">
          <Icon size={18} />
        </div>
