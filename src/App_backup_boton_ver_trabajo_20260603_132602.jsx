          ...
          <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-800 p-5 text-white">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                ...
                <button onClick={() => setVerDetalles(!verDetalles)} className="flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-base font-black text-white shadow-lg shadow-blue-900/20 transition hover:-translate-y-0.5">
