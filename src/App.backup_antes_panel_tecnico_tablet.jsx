...
export default function App() {
  ...
  const [tecnicoVista, setTecnicoVista] = useState("trabajo");
      ...
      <main className="w-full min-w-0 px-2.5 2xl:px-6 py-3 2xl:py-5">
        ...
        {session.role === "tecnico" && (
          <>
            ...
            <section className="mb-4 overflow-hidden rounded-3xl border border-white/70 bg-white/95 shadow-xl shadow-slate-300/60">
              <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-900 px-5 py-3 text-white">
                <p className="text-[10px] font-black uppercase tracking-[0.28em] text-cyan-300">
                  Panel del técnico
                </p>
                <h2 className="mt-1 text-lg font-black">{session.nombre}</h2>
                <p className="mt-1 text-sm font-semibold text-slate-300">
                  Trabajo actual e historial separados.
                </p>
              </div>

              <div className="grid gap-3 bg-slate-50 p-3 sm:grid-cols-2">
                <button
                  onClick={() => setTecnicoVista("trabajo")}
                  className={
                    "group relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-600 via-blue-700 to-slate-950 p-5 text-left text-white shadow-xl shadow-blue-950/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl " +
                    (tecnicoVista === "trabajo" ? "ring-4 ring-cyan-200 scale-[1.01]" : "opacity-90 hover:opacity-100")
                  }
                >
                  <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-white/15 blur-2xl transition group-hover:scale-125" />
                  <div className="absolute bottom-0 left-0 h-1 bg-white transition-all duration-500"
                    style={{ width: tecnicoVista === "trabajo" ? "100%" : "0%" }}
                  />
                  ...
                  <div className="relative z-10 flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-lg font-black">Trabajo actual</p>
                      <p className="mt-1 text-xs font-bold text-cyan-100">
                        Agenda, órdenes activas y próximas tareas
                      </p>
                    </div>

                    <div className="text-right">
                      <p className="text-5xl font-black leading-none">
                        {ordenesActivasTecnico.length + citas.filter((c) => String(c.tecnicoId) === String(session.id)).length}
                      </p>
                      <p className="mt-1 text-[10px] font-black uppercase tracking-wide text-cyan-100">
                        tareas
                      </p>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className={
                    "group relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-green-700 to-slate-950 p-5 text-left text-white shadow-xl shadow-emerald-950/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl " +
                    (tecnicoVista === "historial" ? "ring-4 ring-emerald-200 scale-[1.01]" : "opacity-90 hover:opacity-100")
                  }
                >
                  <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-white/15 blur-2xl transition group-hover:scale-125" />
                  <div className="absolute bottom-0 left-0 h-1 bg-white transition-all duration-500"
                    style={{ width: tecnicoVista === "historial" ? "100%" : "0%" }}
                  />
                  ...
                  <div className="relative z-10 flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-lg font-black">Historial</p>
                      <p className="mt-1 text-xs font-bold text-emerald-100">
                        Completadas, canceladas y reportes anteriores
                      </p>
                    </div>

                    <div className="text-right">
                      <p className="text-5xl font-black leading-none">
                        {historialTecnico.length}
                      </p>
            ...
            {tecnicoVista === "trabajo" && (
              <TecnicoOrdenesPanel ordenes={ordenesActivasTecnico} citas={citas.filter((c) => String(c.tecnicoId) === String(session.id))} obtenerCliente={obtenerCliente} ordenProps={ordenProps} />
            )}
