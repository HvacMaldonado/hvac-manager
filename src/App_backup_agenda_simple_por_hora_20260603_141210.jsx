...
function TecnicoAssignedTodayPanel({ ordenes = [], citas = [], obtenerCliente, ordenProps, onAbrirOrden }) {
  ...
  if (ordenesHoy.length === 0) {
    return (
      <section className="rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-md shadow-slate-300/40">
          ...
          {ordenesHoy.map((orden) => {
            ...
            return (
              <button
                ...
                className="grid w-full gap-3 rounded-[1.75rem] border border-slate-200 bg-gradient-to-br from-white via-blue-50/40 to-cyan-50/40 p-4 text-left shadow-md shadow-slate-200/70 transition hover:-translate-y-0.5 hover:border-cyan-300 hover:shadow-xl sm:grid-cols-[120px_minmax(0,1fr)]"
              >
                <div className="flex items-center justify-center rounded-3xl bg-slate-950 px-4 py-5 text-white shadow-lg shadow-slate-300">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {telefono && (
                      <a
                        ...
                        className="inline-flex items-center justify-center rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-black text-white shadow-md shadow-emerald-200"
                      >
                        Llamar
                      </a>
                    )}
                    ...
                    {telefono && (
                      <a
                        href={`sms:${telefono}`}
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-4 py-2.5 text-sm font-black text-white shadow-md shadow-blue-200"
                      >
                        Mensaje
                      </a>
                    )}
                    ...
                    {direccion && (
                      <a
                        ...
                        rel="noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center justify-center rounded-2xl bg-slate-950 px-4 py-2.5 text-sm font-black text-white shadow-md shadow-slate-300"
                      >
                        Dirección
                      </a>
                    )}

                    <span className="inline-flex items-center justify-center rounded-2xl bg-white px-4 py-2.5 text-sm font-black text-cyan-700 ring-1 ring-cyan-100">
                      Tocar para abrir orden
                    </span>
                  </div>
                </div>
              </button>
