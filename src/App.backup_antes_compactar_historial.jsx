          ...
          <>
            ...
            <section className="mb-4 overflow-hidden rounded-3xl border border-white/70 bg-white/95 shadow-xl shadow-slate-300/60">
              <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-900 p-5 text-white">
                ...
                <h2 className="mt-1 text-2xl font-black">{session.nombre}</h2>
  ...
  return (
    <div className="fixed inset-0 z-[980] flex items-center justify-center bg-slate-950/75 p-3 backdrop-blur-sm">
      <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl shadow-slate-950/50">
        <header className="flex items-center justify-between bg-gradient-to-br from-blue-950 via-cyan-800 to-teal-700 p-5 text-white">
          <div>
...
function CancelOrderModal({ open, orden, cliente, tecnico, onClose, onConfirm, session }) {
  ...
  return (
    <div className="fixed inset-0 z-[980] flex items-center justify-center bg-slate-950/75 p-3 backdrop-blur-sm">
      <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl shadow-slate-950/50">
        <header className="flex items-center justify-between bg-gradient-to-br from-rose-950 via-red-800 to-orange-700 p-5 text-white">
          <div>
...
function TecnicoAssignedTodayPanel({ ordenes = [], citas = [], obtenerCliente }) {
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white/95 shadow-xl shadow-slate-300/50">
      <div className="border-b border-slate-200 bg-gradient-to-r from-slate-950 via-blue-950 to-cyan-900 p-5 text-white">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="rounded-2xl bg-white/10 px-4 py-3 text-center ring-1 ring-white/20">
              <p className="text-xl font-black">{countOrdenes}</p>
              <p className="text-[9px] font-black uppercase tracking-wide text-blue-100">Órdenes</p>
            </div>
            <div className="rounded-2xl bg-white/10 px-4 py-3 text-center ring-1 ring-white/20">
              <p className="text-xl font-black">{countCitas}</p>
  ...
  return (
    <section className="space-y-4">
      <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/95 shadow-xl shadow-slate-300/50">
        <div className="bg-gradient-to-br from-slate-950 via-emerald-950 to-cyan-900 p-5 text-white">
        ...
        <div className="grid gap-3 border-b border-slate-200 bg-white p-3 sm:grid-cols-3">
          <div className="rounded-2xl bg-slate-950 p-4 text-white">
            ...
            <p className="mt-1 text-3xl font-black">{ordenes.length}</p>
          </div>

          <div className="rounded-2xl bg-emerald-50 p-4 text-emerald-800 ring-1 ring-emerald-100">
            <p className="text-xs font-black uppercase tracking-wide text-emerald-600">Completadas</p>
            <p className="mt-1 text-3xl font-black">{completadas.length}</p>
          </div>

          <div className="rounded-2xl bg-rose-50 p-4 text-rose-800 ring-1 ring-rose-100">
            <p className="text-xs font-black uppercase tracking-wide text-rose-600">Canceladas</p>
            <p className="mt-1 text-3xl font-black">{canceladas.length}</p>
          </div>
        </div>
        ...
        <div className="space-y-3 bg-slate-50 p-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-white py-3 pl-11 pr-4 text-sm font-semibold outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100"
            />
          </div>
          ...
          {ordenesFiltradas.map((orden) => {
            ...
            return (
              <article
                key={orden.id}
                className={
                  "overflow-hidden rounded-3xl border bg-white shadow-lg shadow-slate-200/70 " +
                  (completada ? "border-emerald-200" : "border-rose-200")
                }
              >
                <div
                  className={
                    "flex flex-col gap-3 p-4 text-white sm:flex-row sm:items-center sm:justify-between " +
                    (completada
