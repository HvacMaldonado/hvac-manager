      ...
      <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/95 shadow-xl shadow-slate-300/60 backdrop-blur">
        <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-900 p-5 text-white">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-cyan-300">Historial</p>
              <h2 className="mt-1 flex items-center gap-2 text-2xl font-black">
                <FileText size={24} />
                Historial completado
              </h2>
              <p className="mt-1 text-sm text-slate-300">
                Consulta órdenes completadas o canceladas con filtros y acciones rápidas.
              </p>
            </div>
      ...
      <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/95 shadow-xl shadow-slate-300/60 backdrop-blur">
        <div className="bg-slate-950 px-4 py-3 text-white">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.25em] text-cyan-300">Historial completo</p>
              <h3 className="text-lg font-black">Órdenes cerradas y canceladas</h3>
            </div>
        ...
        <div className="space-y-3 bg-slate-50 p-3">
          ...
          {historialFiltrado.map((orden) => {
            ...
            return (
              <article key={orden.id} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-200 hover:shadow-xl">
                  ...
                  <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-700 to-cyan-700 px-3 text-sm font-black text-white shadow-sm"
                      >
                        <Eye size={15} />
                        Ver orden
                      </button>
